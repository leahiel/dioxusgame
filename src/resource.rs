...
pub fn init_resources(cx: Scope) {
    ...
    resources_hashmap.insert("destiny", Resource { name: "Destiny", ..Default::default()});
    resources_hashmap.insert("energy", Resource { name: "Energy", amountcurrent: Decimal::from_number(10.0), ..Default::default()});
